...
namespace GGST_COLOR_UNLOCKER_GUI
{
    public partial class MainForm : Form
    {
        ...
        const string colorPSNPatternOffset = "GGST-Win64-Shipping.exe+0xEA3E24";
        static byte[] colorPSNPattern = { 0x74, 0x08, 0x48, 0x8B, 0xCF, 0xE8, 0xD2, 0x2F, 0x25, 0x00, 0x0F, 0xB6, 0xC3 };

        const string colorSPPattern1Offset = "GGST-Win64-Shipping.exe+0xC17BB1";
        static byte[] colorSPPattern1 = { 0xE8, 0xCA, 0x97, 0xF7, 0xFF, 0x48, 0x63, 0x8B, 0x38, 0x04, 0x00, 0x00, 0x0F, 0xBE, 0x44, 0x08, 0x03 };

        const string colorSPPattern2Offset = "GGST-Win64-Shipping.exe+0xC0A57E";
        ...
        static byte[] patchPSN = {
            ...
            0xE8, 0xD2, 0x2F, 0x25, 0x00,   //  call func
            0x90, 0x90, 0x90,               //  NOP NOP NOP - Replacing movzx eax,bl - PSN COLOR CHECK
        };

        static byte[] patchSP1 =
        {
            0xE8, 0xCA, 0x97, 0xF7, 0xFF,               //  call func
            0x48, 0x63, 0x8B, 0x38, 0x04, 0x00, 0x00,   //  movsxd  rcx,dword ptr [rdi+00000428]
